...
(cl:defmethod cl:initialize-instance :after ((m <CognitiveContent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CognitiveContent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidapy_rosdeps-msg:<CognitiveContent> is deprecated: use lidapy_rosdeps-msg:CognitiveContent instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CognitiveContent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidapy_rosdeps-msg:header-val is deprecated.  Use lidapy_rosdeps-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'elements-val :lambda-list '(m))
(cl:defmethod elements-val ((m <CognitiveContent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidapy_rosdeps-msg:elements-val is deprecated.  Use lidapy_rosdeps-msg:elements instead.")
  (elements m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CognitiveContent>)))
  ...
  "lidapy_rosdeps/CognitiveContent")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CognitiveContent)))
  "Returns string type for a message object of type 'CognitiveContent"
  "lidapy_rosdeps/CognitiveContent")
