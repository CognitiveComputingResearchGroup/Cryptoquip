...
(cl:defmethod cl:initialize-instance :after ((m <decayModule-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'decayModule-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidapy_rosdeps-srv:<decayModule-request> is deprecated: use lidapy_rosdeps-srv:decayModule-request instead.")))

(cl:ensure-generic-function 'n-val :lambda-list '(m))
(cl:defmethod n-val ((m <decayModule-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidapy_rosdeps-srv:n-val is deprecated.  Use lidapy_rosdeps-srv:n instead.")
  (n m))

(cl:ensure-generic-function 'strategy-val :lambda-list '(m))
(cl:defmethod strategy-val ((m <decayModule-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidapy_rosdeps-srv:strategy-val is deprecated.  Use lidapy_rosdeps-srv:strategy instead.")
  (strategy m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<decayModule-request>)))
  ...
  "lidapy_rosdeps/decayModuleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'decayModule-request)))
  "Returns string type for a service object of type 'decayModule-request"
  "lidapy_rosdeps/decayModuleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <decayModule-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'decayModule-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidapy_rosdeps-srv:<decayModule-response> is deprecated: use lidapy_rosdeps-srv:decayModule-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<decayModule-response>)))
  ...
  "lidapy_rosdeps/decayModuleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'decayModule-response)))
  "Returns string type for a service object of type 'decayModule-response"
  "lidapy_rosdeps/decayModuleResponse")
