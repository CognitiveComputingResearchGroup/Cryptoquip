...
(cl:defmethod cl:initialize-instance :after ((m <KeyValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-msg:<KeyValues> is deprecated: use cqlida-msg:KeyValues instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <KeyValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-msg:key-val is deprecated.  Use cqlida-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <KeyValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-msg:values-val is deprecated.  Use cqlida-msg:values instead.")
  (values m))
