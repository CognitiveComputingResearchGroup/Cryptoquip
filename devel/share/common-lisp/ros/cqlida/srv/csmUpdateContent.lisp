...
(cl:defclass <csmUpdateContent-request> (roslisp-msg-protocol:ros-message)
  ((target
    :reader target
    :initarg :target
    :type cqlida-msg:CognitiveContent
    :initform (cl:make-instance 'cqlida-msg:CognitiveContent))
   (update
    :reader update
    :initarg :update
    :type cqlida-msg:CognitiveContent
...
(cl:defmethod cl:initialize-instance :after ((m <csmUpdateContent-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmUpdateContent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmUpdateContent-request> is deprecated: use cqlida-srv:csmUpdateContent-request instead.")))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <csmUpdateContent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-srv:target-val is deprecated.  Use cqlida-srv:target instead.")
  (target m))

(cl:ensure-generic-function 'update-val :lambda-list '(m))
(cl:defmethod update-val ((m <csmUpdateContent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-srv:update-val is deprecated.  Use cqlida-srv:update instead.")
  (update m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<csmUpdateContent-request>)))
  ...
  "cqlida/csmUpdateContentRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'csmUpdateContent-request)))
  "Returns string type for a service object of type 'csmUpdateContent-request"
  "cqlida/csmUpdateContentRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <csmUpdateContent-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmUpdateContent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmUpdateContent-response> is deprecated: use cqlida-srv:csmUpdateContent-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<csmUpdateContent-response>)))
  ...
  "cqlida/csmUpdateContentResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'csmUpdateContent-response)))
  "Returns string type for a service object of type 'csmUpdateContent-response"
  "cqlida/csmUpdateContentResponse")
