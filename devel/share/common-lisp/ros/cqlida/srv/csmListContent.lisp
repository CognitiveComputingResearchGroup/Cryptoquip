...
(cl:defmethod cl:initialize-instance :after ((m <csmListContent-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmListContent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmListContent-request> is deprecated: use cqlida-srv:csmListContent-request instead.")))

(cl:ensure-generic-function 'max_results-val :lambda-list '(m))
(cl:defmethod max_results-val ((m <csmListContent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-srv:max_results-val is deprecated.  Use cqlida-srv:max_results instead.")
  (max_results m))
...
(cl:defmethod cl:initialize-instance :after ((m <csmListContent-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmListContent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmListContent-response> is deprecated: use cqlida-srv:csmListContent-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<csmListContent-response>)))
  ...
  (cl:format cl:nil "cqlida/KeyValues[] content~%~%~%================================================================================~%MSG: cqlida/KeyValues~%string key~%string[] values~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'csmListContent-response)))
  "Returns full string definition for message of type 'csmListContent-response"
  (cl:format cl:nil "cqlida/KeyValues[] content~%~%~%================================================================================~%MSG: cqlida/KeyValues~%string key~%string[] values~%~%~%"))
