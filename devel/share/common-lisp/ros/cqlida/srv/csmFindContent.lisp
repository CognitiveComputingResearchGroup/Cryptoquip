...
(cl:defmethod cl:initialize-instance :after ((m <csmFindContent-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmFindContent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmFindContent-request> is deprecated: use cqlida-srv:csmFindContent-request instead.")))

(cl:ensure-generic-function 'filters-val :lambda-list '(m))
(cl:defmethod filters-val ((m <csmFindContent-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-srv:filters-val is deprecated.  Use cqlida-srv:filters instead.")
  (filters m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<csmFindContent-request>)))
  ...
  (cl:format cl:nil "cqlida/KeyValues[] filters~%~%================================================================================~%MSG: cqlida/KeyValues~%string key~%string[] values~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'csmFindContent-request)))
  "Returns full string definition for message of type 'csmFindContent-request"
  (cl:format cl:nil "cqlida/KeyValues[] filters~%~%================================================================================~%MSG: cqlida/KeyValues~%string key~%string[] values~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <csmFindContent-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'csmFindContent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cqlida-srv:<csmFindContent-response> is deprecated: use cqlida-srv:csmFindContent-response instead.")))

(cl:ensure-generic-function 'found_content-val :lambda-list '(m))
(cl:defmethod found_content-val ((m <csmFindContent-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cqlida-srv:found_content-val is deprecated.  Use cqlida-srv:found_content instead.")
  (found_content m))
