...
# Topic definitions
PUZZLE_TOPIC = FrameworkTopic("/cryptoquip/puzzle", Cryptoquip)
GUESS_TOPIC = FrameworkTopic("/gazebo/commands", WheelCommand)
...
class CQEnvironment(FrameworkModule):
    def __init__(self, **kwargs):
        super(CQEnvironment, self).__init__(**kwargs)

    def add_subscribers(self):
        super(CQEnvironment, self).add_subscribers()
        super(CQEnvironment, self).add_subscriber(RAYSCAN_TOPIC)
